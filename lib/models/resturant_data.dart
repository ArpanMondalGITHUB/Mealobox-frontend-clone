...
ResturantData resturantDataFromJson(dynamic str) {
  final jsonData = json.decode(str);
  return ResturantData.fromJson(jsonData);
}

String bannersDatatoJson(ResturantData data) {
...
class ResturantData {
  ...
  ResturantData({this.homekitchen});
